...
Тестировать можно дизайн сайта, цвет и расположение кнопкок, форму регистрации, оформление почтовой-рассылки, текст объявления на сайте и другие изменения. 
