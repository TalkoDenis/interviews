Ниже представлен ряд вопросов по Python.
...
#### 2. В чем разница между is и ==?
<details>
<summary>Ответ</summary>
is проверяет идентичность, а == проверяет равенство.
</details>

#### 3. Что такое операторы тождественности в Python?
<details>
<summary>Ответ</summary>
...
#### 5. Как работает умножение строк?
<details>
<summary>Ответ</summary>
...
#### 6. Как работает умножение списка?
<details>
<summary>Ответ</summary>
...
#### 7. Как объединить списки в Python?
<details>
<summary>Ответ</summary>
...
#### 8. Назовите изменяемые и неизменяемые объекты
<details>
<summary>Ответ</summary>
...
#### 9. Как округлить число до трех десятичных знаков?
<details>
<summary>Ответ</summary>
...
#### 10. Что такое срез? Как разбить список?
<details>
<summary>Ответ</summary>
...
#### 12. Какая разница между словарями и JSON?
<details>
<summary>Ответ</summary>
...
#### 13. Как работают any() и all()?
<details>
<summary>Ответ</summary>

_Any_ возвращает true, если хоть один элемент в последовательности соответствует условию, то есть является true.

_All_ возвращает true только в том случае, если условию соответствуют все элементы в последовательности.
...
#### 14. Где быстрее поиск: в словарях или списках?
<details>
<summary>Ответ</summary>
...
#### 15. Как удалить из списка дубликаты?
<details>
<summary>Ответ</summary>
...
#### 16. Как проверить, существует ли значение в списке?
<details>
<summary>Ответ</summary>
...
#### 17. В чем разница между append и extend?
<details>
<summary>Ответ</summary>
...
#### 18. Как получить абсолютное значение целого числа?
<details>
<summary>Ответ</summary>
...
#### 19. Как отсортировать словарь по ключам, в алфавитном порядке?
<details>
<summary>Ответ</summary>
...
#### 21. Почему используется enumerate() при итерации последовательности?
<details>
<summary>Ответ</summary>
...
#### 22. В чем разница между pass, continue и break?
<details>
<summary>Ответ</summary>
...
#### 23. Что такое генератор списков (list comprehension)?
<details>
<summary>Ответ</summary>
...
#### 24. Что такое тернарного оператора?
<details>
<summary>Ответ</summary>
...
#### 25. Как проверить, что строка состоит только из чисел?
<details>
<summary>Ответ</summary>
...
#### 26. Как проверить, что строка состоит только из буквы?
<details>
<summary>Ответ</summary>
...
#### 27. Как проверить, что строка состоит только из букв и цифр?
<details>
<summary>Ответ</summary>
...
#### 28. Как получитть список ключей из словаря?
<details>
<summary>Ответ</summary>
...
#### 29. Как перевести строку в верхний/нижний регистр?
<details>
<summary>Ответ</summary>
...
#### 30. В чем разница между remove, del и pop?
<details>
<summary>Ответ</summary>
...
#### 31. Как выполняется обработка исключений в Python?
<details>
<summary>Ответ</summary>
...
#### 32. Как прокомментировать несколько строк в Python?
<details>
<summary>Ответ</summary>
...
#### 34. Обязательны ли отступы в Python?
<details>
<summary>Ответ</summary>
...
#### 35. Что такое функция в Python? Как функция определяется?
<details>
<summary>Ответ</summary>
  
_Функция_ - это блок кода, который выполняется только при его вызове. Для определения функции Python используется ключевое слово def. Если функция возвращает что-то, ей нужно ключевое слово return.
...
#### 37. Что такое локальные и глобальные переменные в Python?
<details>
<summary>Ответ</summary>
...
#### 38. Какие типы данных поддерживаются в Python?
<details>
<summary>Ответ</summary>
...
#### 40. Что такое отрицательные индексы и почему они используются?
<details>
<summary>Ответ</summary>
...
#### 42. Как получить доступ к значениям в словаре?
<details>
<summary>Ответ</summary>
...
#### 43. Как получить список всех ключей в словаре?
<details>
<summary>Ответ</summary>
...
#### 44. В чем разница между списком и кортежем?
<details>
<summary>Ответ</summary>
...
#### 45. Что такое тернарный оператор?
<details>
<summary>Ответ</summary>
...
#### 47. Что такое функция enumerate в Python?
<details>
<summary>Ответ</summary>
...
#### 48. Каков смысл not в операторе?
<details>
<summary>Ответ</summary>
...
#### 50. Как добавить новое значение в объект списка?
<details>
<summary>Ответ</summary>
...
#### 51. Как преобразовать список в строку?
<details>
<summary>Ответ</summary>
...
#### 52. Что такое оператор членства?
<details>
<summary>Ответ</summary>
...
#### 53. Как обрабатывать входные данные в Python?
<details>
<summary>Ответ</summary>
...
#### 54. Что такое функция range? В чем разница между тем, когда функция range() принимает один аргумент, два и три?
<details>
<summary>Ответ</summary>
...
#### 55. Напишите лучший код для перестановки двух чисел местами.
<details>
<summary>Ответ</summary>
...
#### 56. Что делает оператор with в Python?
<details>
<summary>Ответ</summary>
...
#### 57. Когда выполняется except, в блоке try-except?
<details>
<summary>Ответ</summary>
...
#### 58. Для чего используется while вместо for?
...
#### 60. Назовите пример режимов обработки файлов с помощью Python?
...
#### 61. Что такое конкатенация строк?
...
#### 62. Что такое приведение в Python?
...
#### 63. Как можно удалить переменные в Python?
...
#### 65. Что значит *args, **kwargs? И зачем нам их использовать?
...
#### 66. Что выполняет функция help() в Python?
...
#### 67. Как разделить строку на список?
<details>
<summary>Ответ</summary>
...
#### 68. Что такое палином? Напишите программу на Python, чтобы проверить, является ли последовательность, которую вы вводите, палиндромом
<details>
<summary>Ответ</summary>
...
#### 69. Что такое генератор?

<details>
<summary>Ответ</summary>
Генератор Python создает последовательность значений для итерации, часто с помощью функции. Мы определяем функцию с помощью _yield_, которая используется для получения значения по одному, а затем используем цикл for для итерации.
...
#### 70. Напишите программу на Python для проверки, является ли число простым
...
#### 71. Что такое распаковка кортежа?
...
#### 72. Является ли функция допустимой, если она не имеет оператора return?
