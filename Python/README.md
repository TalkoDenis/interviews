...
<details>
<summary>Ответ</summary>
Они показывают, тождественны ли два значения. Операторы - 'is' и 'is not'.
...
<details>
<summary>Ответ</summary>
Когда передаётся только один аргумент, функция принимает его в качестве стоп-значения. Здесь начальное значение равно 0, а шаговое +1. Итерация с диапазоном всегда будет останавливаться на единицу перед стоп-значением.
